Public Class frmMCQTest6

    Private Sub frmMCQTest6_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If user = "Tester" Then
            lblanswerfeedb.Text = "Correct answer: " & correct_answer(5)
        ...
        lblqindex.Text = Q_number(5)
        lblquestion.Text = question(5)
        lbloption1.Text = optionA(5)
        lbloption2.Text = optionB(5)
        lbloption3.Text = optionC(5)
        lbloption4.Text = optionD(5)
