Public Class frmMCQTest7

    Private Sub frmMCQTest7_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If user = "Tester" Then
            lblanswerfeedb.Text = "Correct answer: " & correct_answer(6)
        ...
        lblqindex.Text = Q_number(6)
        lblquestion.Text = question(6)
        lbloption1.Text = optionA(6)
        lbloption2.Text = optionB(6)
        lbloption3.Text = optionC(6)
        lbloption4.Text = optionD(6)
