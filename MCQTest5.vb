Public Class frmMCQTest5

    Private Sub frmMCQTest5_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If user = "Tester" Then
            lblanswerfeedb.Text = "Correct answer: " & correct_answer(4)
        ...
        lblqindex.Text = Q_number(4)
        lblquestio.Text = question(4)
        lbloption1.Text = optionA(4)
        lbloption2.Text = optionB(4)
        lbloption3.Text = optionC(4)
        lbloption4.Text = optionD(4)
