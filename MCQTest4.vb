Public Class frmMCQTest4

    Private Sub frmMCQTest2_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If user = "Tester" Then
            lblanswerfeedb.Text = "Correct answer: " & correct_answer(3)
        ...
        lblqindex.Text = Q_number(3)
        lblquestion.Text = question(3)
        lbloption1.Text = optionA(3)
        lbloption2.Text = optionB(3)
        lbloption3.Text = optionC(3)
        lbloption4.Text = optionD(3)
