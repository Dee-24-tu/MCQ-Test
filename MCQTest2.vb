Public Class frmMCQTest2
    ...
    Private Sub frmMCQTest2_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If user = "Tester" Then
            lblanswerfeedb.Text = "Correct answer: " & correct_answer(1)
        ...
        lblqindex.Text = Q_number(1)
        lblquestion.Text = question(1)
        lbloption1.Text = optionA(1)
        lbloption2.Text = optionB(1)
        lbloption3.Text = optionC(1)
        lbloption4.Text = optionD(1)
