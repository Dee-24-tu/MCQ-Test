Public Class frmMCQTest3

    Private Sub frmMCQTest3_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If user = "Tester" Then
            lblanswerfeedb.Text = "Correct answer: " & correct_answer(2)
        ...
        lblqindex.Text = Q_number(2)
        lblquestion.Text = question(2)
        lbloption1.Text = optionA(2)
        lbloption2.Text = optionB(2)
        lbloption3.Text = optionC(2)
        lbloption4.Text = optionD(2)
